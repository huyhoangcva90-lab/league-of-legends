...
Add-Contract 'State' 'Versioned persisted-state migration' ($app -match 'STATE_SCHEMA_VERSION\s*=\s*4' -and $app -match 'function\s+mergeState') 'STATE_SCHEMA_VERSION=4 + mergeState'
