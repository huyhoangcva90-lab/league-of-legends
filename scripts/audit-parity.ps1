...
Add-Contract 'Team' 'Composition strategy implements Team row 41, Setting ranks and fight-aware phase scoring' ((Has-All $app @('teamMatrixTab','teamStrategyPhase','sheetTacticalCounts','sheetCombatPrimary','sheetCombatSecondary','sheetMacroType','sheetWinConditionSignature','sheetDetailedRuleResults','sheetRankedTeamTypes','teamTypePrimary','teamTypeSecondary','Setting!O31 / O32','Setting!P31 / P32','teamStrategyMetricScores=function','sheetPhaseBaseScore','teamfightPhaseQuality','teamStrategyPhaseDetail','teamStrategyPentagon','strategyPhaseCompareRow','Team!E41:K41','Team!S41:Y41','data-team-matrix-tab','data-team-strategy-phase')) -and (Has-All $style @('\.team-matrix-tabs','\.team-strategy-scoreboard','\.team-strategy-sides','\.team-strategy-signature','\.team-strategy-classification','\.strategy-primary','\.team-strategy-pentagon','\.team-pentagon-fill','\.phase-detail')) -and $teamRulesText -match 'sheetPhaseRoleScores' -and $teamRulesText -match 'sheetTeamfightPhaseWeights' -and $teamRulesText -match 'sheetMacroPhaseWeights' -and $teamRulesText -match 'sheetWinConditionLabels') 'AN:AR pentagon, exact role phase base, teamfight/map phase adjustments, Team combat IFS, Split+2 macro, and Setting five-category ranking'
