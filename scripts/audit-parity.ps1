...
Add-Contract 'Team' 'My Team marker defaults to Blue and replaces title scores' ((Has-All $app @('function\s+myTeamMarker','data-my-team-side',"state\.perspective==='red'\?'red':'blue'")) -and $app -notmatch 'team-sheet-title.*teamScore') 'Exclusive Blue/Red checkbox; unchecked neutral state resolves to Blue; aggregate title score removed'
