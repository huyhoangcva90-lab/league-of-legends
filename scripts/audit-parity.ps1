...
Add-Contract 'Team' 'Composition strategy implements the exact Team row 41 formula band' ((Has-All $app @('teamMatrixTab','teamStrategyPhase','sheetCombatPrimary','sheetCombatSecondary','sheetMacroType','sheetWinConditionSignature','sheetDetailedTeamType','teamStrategyMetricScores=function','teamStrategyPhaseScore=function','Team!E41:K41','Team!S41:Y41','data-team-matrix-tab','data-team-strategy-phase')) -and (Has-All $style @('\.team-matrix-tabs','\.team-strategy-scoreboard','\.team-strategy-sides','\.team-strategy-signature','\.team-strategy-classification')) -and $teamRulesText -match 'sheetPhaseRoleScores' -and $teamRulesText -match 'sheetWinConditionLabels') 'AN:AR sums, role-specific phase scores, primary/secondary combat IFS, Split+2 macro rule and Setting win-condition chain'
